			...
			<div class="modal-body">
				<form class="form-horizontal"  action="${pageContext.request.contextPath }/updateDriver.action" 
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="editDriverdriverstate" placeholder="select" name="driverstate"value="" />
						</div>
					</div>	
						<div class="form-group">
		...
		function edit(id) {
			$.ajax({
		        ...
		        success:function(data) {  
		            ...
		            $("#editDriverdriverstate").val(data.driverstate);
		            $("#editDriveremail").val(data.email);
		            $("#editDriverlocked").val(data.locked);
		            $("#editDriverlastlogin").val(data.lastlogin);
		            $("#editDriveractivated").val(data.activated);
		            $("#editDriversubscribed").val(data.subscribed);
